...
export const MAppleIcon = makeBrandIcon(
    'MAppleIcon',
    <>
        <path
...
export const MAppleColorIcon = makeBrandIcon(
    'MAppleColorIcon',
    <>
        <path
            d="M15.1 12.15c.02 2.1 1.84 2.8 1.86 2.81-.02.06-.29.98-.95 1.94-.57.83-1.16 1.66-2.1 1.68-.93.01-1.23-.55-2.3-.55s-1.41.53-2.27.57c-.91.03-1.6-.91-2.17-1.73-1.17-1.7-2.07-4.8-.87-6.88.6-1.03 1.66-1.69 2.81-1.71.88-.02 1.7.59 2.3.59.6 0 1.72-.73 2.9-.62.49.02 1.88.2 2.77 1.51-.07.04-1.65.96-1.63 2.39z"
...
export const MAmazonIcon = makeBrandIcon(
    'MAmazonIcon',
    <>
        <path
...
export const MAmazonColorIcon = makeBrandIcon(
    'MAmazonColorIcon',
    <>
        <path
            d="M8.1 9.45c1.06-.68 2.47-.95 3.88-.95 1.22 0 2.45.2 3.41.57v4.58c0 .48.18.68.52.91v.37c-.43.37-1 .62-1.62.62-.52 0-.89-.2-1.2-.62-.8.52-1.52.62-2.44.62-1.54 0-2.48-.93-2.48-2.36 0-1.13.62-1.93 1.84-2.34.95-.31 2.17-.37 3.08-.5v-.31c0-.26-.02-.58-.18-.8-.16-.2-.43-.29-.7-.29-.53 0-1.03.25-1.15.8-.03.13-.12.25-.27.26l-1.53-.17c-.13-.03-.27-.13-.24-.37.23-1.43 1.56-2.07 3.08-2.07zM13.05 12.1c-.46.1-.98.15-1.38.35-.47.24-.76.59-.76 1.18 0 .6.37.98.94.98.43 0 .84-.2 1.12-.52.34-.4.31-.8.31-1.3z"
...
export const MMastercardIcon = makeBrandIcon(
    'MMastercardIcon',
    <>
...
export const MMastercardColorIcon = makeBrandIcon(
...
export const MDiscoverIcon = makeBrandIcon(
    'MDiscoverIcon',
    <>
        <path
            d="M5.7 12c0-2.8 2.27-5.05 5.08-5.05 1.59 0 3.01.73 3.94 1.87h-1.92c-.58-.37-1.28-.58-2.02-.58-2.05 0-3.71 1.67-3.71 3.76s1.66 3.76 3.71 3.76c.74 0 1.44-.21 2.02-.58h1.92c-.93 1.14-2.35 1.87-3.94 1.87-2.81 0-5.08-2.25-5.08-5.05z"
            fill="currentColor"
            stroke="none"
        />
        <path d="M14.2 12a3.2 3.2 0 0 1 3.2-3.2v6.4a3.2 3.2 0 0 1-3.2-3.2z" fill="currentColor" stroke="none" />
        <path d="M17.4 8.8h1.3l-2.15 3.2L18.7 15.2h-1.3L15.25 12z" fill="currentColor" stroke="none" />
    </>
)

export const MDiscoverColorIcon = makeBrandIcon(
    'MDiscoverColorIcon',
    <>
        <path
            d="M5.7 12c0-2.8 2.27-5.05 5.08-5.05 1.59 0 3.01.73 3.94 1.87h-1.92c-.58-.37-1.28-.58-2.02-.58-2.05 0-3.71 1.67-3.71 3.76s1.66 3.76 3.71 3.76c.74 0 1.44-.21 2.02-.58h1.92c-.93 1.14-2.35 1.87-3.94 1.87-2.81 0-5.08-2.25-5.08-5.05z"
            ...
            stroke="none"
        />
        <path d="M14.2 12a3.2 3.2 0 0 1 3.2-3.2v6.4a3.2 3.2 0 0 1-3.2-3.2z" fill="#ff7a00" stroke="none" />
        <path d="M17.4 8.8h1.3l-2.15 3.2L18.7 15.2h-1.3L15.25 12z" fill="#ff7a00" stroke="none" />
    </>
)

export const MMaestroIcon = makeBrandIcon(
    'MMaestroIcon',
    <>
        <circle cx="10" cy="12" r="4.3" fill="currentColor" stroke="none" opacity="0.95" />
        <circle cx="14" cy="12" r="4.3" fill="currentColor" stroke="none" opacity="0.65" />
        <path d="M12 8.1a4.3 4.3 0 0 1 0 7.8 4.3 4.3 0 0 1 0-7.8z" fill="currentColor" stroke="none" opacity="0.3" />
    </>
)

export const MMaestroColorIcon = makeBrandIcon(
    'MMaestroColorIcon',
    <>
        <circle cx="10" cy="12" r="4.3" fill="#0099df" stroke="none" />
        <circle cx="14" cy="12" r="4.3" fill="#ed1c24" stroke="none" />
        <path d="M12 8.1a4.3 4.3 0 0 1 0 7.8 4.3 4.3 0 0 1 0-7.8z" fill="#6c2bd9" stroke="none" opacity="0.72" />
    </>
)

export const MVisaIcon = makeBrandIcon(
    'MVisaIcon',
    <path
...
export const MVisaColorIcon = makeBrandIcon(
    'MVisaColorIcon',
    <>
...
export const MLetsEncryptIcon = makeBrandIcon(
    'MLetsEncryptIcon',
    <>
...
export const MLetsEncryptColorIcon = makeBrandIcon(
...
export const MMicrosoftIcon = makeBrandIcon(
    'MMicrosoftIcon',
    <>
...
export const MMicrosoftColorIcon = makeBrandIcon(
    'MMicrosoftColorIcon',
    <>
...
export const MPinterestIcon = makeBrandIcon(
    'MPinterestIcon',
    <>
...
export const MPinterestColorIcon = makeBrandIcon(
    'MPinterestColorIcon',
    <>
...
export const MPayPalIcon = makeBrandIcon(
    'MPayPalIcon',
    <>
        <path
...
export const MPayPalColorIcon = makeBrandIcon(
    'MPayPalColorIcon',
    <>
        <path
...
export const MSpotifyIcon = makeBrandIcon(
    'MSpotifyIcon',
    <>
...
export const MSpotifyColorIcon = makeBrandIcon(
    'MSpotifyColorIcon',
    <>
...
export const MTumblrIcon = makeBrandIcon(
    'MTumblrIcon',
    <path
...
export const MTumblrColorIcon = makeBrandIcon(
    'MTumblrColorIcon',
    <path
        d="M13.55 18.2c-.73.35-1.7.48-2.5.48-2.44 0-3.54-1.72-3.54-3.56V11.1H5.95V9.2c1.4-.5 2.23-1.67 2.47-3.4h1.83v3.1h3.02v2.2h-3.02v3.8c0 .88.45 1.4 1.3 1.4.48 0 1-.14 1.3-.29z"
        fill="#001935"
...
export const MUnityIcon = makeBrandIcon(
    'MUnityIcon',
    <>
...
export const MUnityColorIcon = makeBrandIcon(
    'MUnityColorIcon',
    <>
...
export const MVimeoIcon = makeBrandIcon(
    'MVimeoIcon',
    <path
...
export const MVimeoColorIcon = makeBrandIcon(
    'MVimeoColorIcon',
    <path
        d="M6.55 10.3c.79-.69 1.5-1.04 2.13-1.06.55-.02.92.32 1.11 1.04.12.47.31 1.46.57 2.96.26 1.48.54 2.22.83 2.22.23 0 .59-.37 1.06-1.12.48-.75.73-1.32.76-1.7.07-.64-.18-.96-.74-.96-.26 0-.53.06-.81.18.54-1.78 1.58-2.65 3.11-2.6 1.14.04 1.68.82 1.62 2.35-.04 1-.6 2.1-1.67 3.32-1.12 1.27-2.06 1.9-2.82 1.9-.47 0-.87-.43-1.2-1.3-.22-.58-.53-1.68-.93-3.3-.15-.58-.37-.86-.66-.86-.18 0-.49.19-.94.58z"
        fill="#1ab7ea"
...
export const MVkIcon = makeBrandIcon(
    'MVkIcon',
    <path
...
export const MVkColorIcon = makeBrandIcon(
    'MVkColorIcon',
    <path
        d="M6.1 8.35h2.1c.08 4 1.85 5.7 2.41 6.04V8.35h1.98v3.45c.55-.06 2.25-1.7 2.45-3.45h1.97c-.15 1.14-.82 2.3-1.44 3.07-.8 1-1.16 1.38-1.13 1.7.03.36.44.69 1.06 1.3.82.8 1.48 1.5 1.64 2.23h-2.18c-.23-.65-.98-1.6-1.57-2.17-.43-.42-.63-.54-.8-.54-.22 0-.26.12-.26.73v1.98H11.8c-3.96 0-6.22-2.72-6.35-8.33z"
        fill="#0077ff"
