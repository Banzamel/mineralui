...
export const AmericanExpressIcon = forwardRef<SVGSVGElement, IconProps>(function AmericanExpressIcon(props, ref) {
    return (
        <Icon ref={ref} {...props}>
...
export const AmericanExpressColorIcon = forwardRef<SVGSVGElement, IconProps>(
    function AmericanExpressColorIcon(props, ref) {
        return (
            <Icon ref={ref} {...props}>
